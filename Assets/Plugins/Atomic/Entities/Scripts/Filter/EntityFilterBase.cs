...
namespace Atomic.Entities
{
    ...
    public abstract class EntityFilterBase : IEntityFilter
    {
        ...
        private readonly Dictionary<object, object> packedData = new();
        ...
        {
            return this.packedData.TryAdd(key, subscription);
        }

        protected T DelSubscription<T>(object key)
        {
            if (this.packedData.Remove(key, out object value))
            {
                return (T) value;
            }
